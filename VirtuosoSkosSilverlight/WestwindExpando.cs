...
namespace VirtuosoSkosSilverlight
{
    ...
    //original by Westwind Utilities, source: http://www.west-wind.com/weblog/posts/2012/Feb/08/Creating-a-dynamic-extensible-C-Expando-Object
    public class WestwindExpando : DynamicObject, IDynamicMetaObjectProvider
    {
        /// <summary>
        ...
        // customization for this project and the only change to the original Wsetwind.Expando - no need for serializable Dictionary here
        ...
        public WestwindExpando(object instance)
        {
            Initialize(instance);
        }
