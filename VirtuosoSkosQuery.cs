...
namespace VirtuosoSkos
{
    public class VirtuosoSkosQuery : ISkosQuery
    {
        ...
        public SparqlResultSet broaderSiblings(string concept, OrderDirection order)
        {
        ...
        public SparqlResultSet broaderSiblings(string concept)
        {
            return broaderSiblings(concept, OrderDirection.NONE);
        }

        public SparqlResultSet narrowerSiblings(string concept, OrderDirection order)
        {
        ...
        public SparqlResultSet narrowerSiblings(string concept)
        {
            return narrowerSiblings(concept, OrderDirection.NONE);
        }
