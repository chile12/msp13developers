...
namespace DocGraphSilverlight
{
    ...
    public class DocGraphQuery
    {
        ...
        {
            querySelect = "SELECT ?doc ?author (STR(?title) as ?title) ?guid (count(?title) as ?hits) ";
            queryWhere = "WHERE {?doc :tagged ?tag. ?tag :means ?skos. ?doc :author ?author. " +
        ...
        public void insertEntry(string guid, string name, Entry entry, List<string> tags, string author = null, string createdBy = null, string spServer = "default" )
        {
